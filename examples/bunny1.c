...
// Utilizando o conjunto de dados do modelo bunny.
...
int main(int argc, char ** argv) {
  ...
  janela = CreateWindow(-0.1,0.015,0.07,0.175);
  porta = CreateViewPort(1,1,600,600,"red");

  // Utilizando o conjunto de dados do modelo bunny
  ob3d_sru = GetData("../examples/data/bunny/faces.txt","../examples/data/bunny/vertices.txt");
  objectVisible(ob3d_sru);  
  SetColorObject3d(ob3d_sru,porta,128);

  observador = SetVetor3d(0.0,0.0,4.5);
