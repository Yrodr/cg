...
polygon * limacons(int, int); // limaçons (se a = b, cardióides)

polygon * limacons(int a, int b) {
...
int main(int argc, char ** argv) {
  ...
  // objeto em coordenadas polares (rho,theta) ->  rho = a + b*cos(theta)
  // quando a = b, as figuras são conhecidas como cardióides  
