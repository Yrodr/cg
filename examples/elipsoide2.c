...
// Um elipsóide de revolução prolato ou alongado corresponde a uma esfera 
// esticada ao longo de um eixo, mantendo os outros inalterados.
...
int main(int argc, char ** argv) {
  ...
  // cria uma superfície de revolução (elipsóide prolato)
  ...
  ob3d_sru = elipsoide_prolato(20,10.0,30,0.8);
