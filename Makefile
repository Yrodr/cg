...
all:
	...
	$(CC) $(INC) ./examples/bezier.c $(OFLAGS) bezier $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/bolinhas1.c $(OFLAGS) bolinhas1 $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/bolinhas2.c $(OFLAGS) bolinhas2 $(EFLAG) $(LIB_2D) $(LIBS)			
	$(CC) $(INC) ./examples/bolinhas3.c $(OFLAGS) bolinhas3 $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/bolinhas4.c $(OFLAGS) bolinhas4 $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/bolinhas5.c $(OFLAGS) bolinhas5 $(EFLAG) $(LIB_2D) $(LIBS)			
	$(CC) $(INC) ./examples/colormaps.c $(OFLAGS) colormaps $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/espiral1.c $(OFLAGS) espiral1 $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/espiral2.c $(OFLAGS) espiral2 $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/lemniscatas.c $(OFLAGS) lemniscatas $(EFLAG) $(LIB_2D) $(LIBS)	
	$(CC) $(INC) ./examples/limacons.c $(OFLAGS) limacons $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/poligonos1.c $(OFLAGS) poligonos1 $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/poligonos2.c $(OFLAGS) poligonos2 $(EFLAG) $(LIB_2D) $(LIBS)	
	$(CC) $(INC) ./examples/rainbow.c $(OFLAGS) rainbow $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/rosaceas.c $(OFLAGS) rosaceas $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/circulos.c $(OFLAGS) circulos $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/letrinhas.c $(OFLAGS) letrinhas $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/poligonos3.c $(OFLAGS) poligonos3 $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/circulo.c $(OFLAGS) circulo $(EFLAG) $(LIB_2D) $(LIBS)
	$(CC) $(INC) ./examples/elipse.c $(OFLAGS) elipse $(EFLAG) $(LIB_2D) $(LIBS)			
